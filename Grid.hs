...
-- Map a function over all Grid elements
gridMap :: (a -> b) -> Grid a -> Grid b
gridMap f (Grid h w xs) = Grid h w (Map.map f xs)
...
-- This is for the partial versions of the mb* functions.
